...
public struct CurrentValueAsyncSequenceReadOnly<Value>: AsyncSequence where Value: Sendable {
    private let source: CurrentValueAsyncSequence<Value>

    init(_ source: CurrentValueAsyncSequence<Value>) {
        self.source = source
    }
...
extension CurrentValueAsyncSequence {
    public nonisolated func readOnly() -> CurrentValueAsyncSequenceReadOnly<Value> {
        CurrentValueAsyncSequenceReadOnly(self)
    }
}
